 ...
 * @author User
 */
public class AusenciaVacacionesForm extends javax.swing.JFrame {

    /**
     * Creates new form AusenciaVacacionesForm
     */
    public AusenciaVacacionesForm() {
        initComponents();
    }
    ...
    private void ConsultRecentActionsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConsultRecentActionsButtonActionPerformed
        ArrayList<Reportes> reporte = Reportes.generarReporteAusenciasVacaciones();
        ...
        modelo.addColumn("Fecha de Asuencia");
        modelo.addColumn("Tipo de Ausencia");
        modelo.addColumn("Detalle de Ausencia");

        for (Reportes r : reporte) {
            //Agregar las filas al modelo
            modelo.addRow(new Object[]{r.getIdEmpleado(), r.getNombre(), r.getApellido(), r.getFechaAccion(), r.getTipoAccion(), r.getDetalleAccion()});
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AusenciaVacacionesForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AusenciaVacacionesForm().setVisible(true);
            }
        });
    }
