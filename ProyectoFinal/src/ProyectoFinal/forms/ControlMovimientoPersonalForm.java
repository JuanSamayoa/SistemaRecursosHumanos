 ...
 * @author User
 */
public class ControlMovimientoPersonalForm extends javax.swing.JFrame {
     ...
     */
    public ControlMovimientoPersonalForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        MovementTypeComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selección una opción", "Promoción", "Transferencia", "Cambio de puesto", "Ascenso", "Reasignación" }));
        ...
        NewSalaryTxt.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(java.text.NumberFormat.getCurrencyInstance())));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(DepartmentComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addComponent(MovementTypeComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 223, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(NewPositionLabel)
                            .addComponent(NewPositionTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 223, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(SalaryLabel)
                            .addComponent(NewSalaryTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(MakeTransitionButton, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(40, 40, 40)
                        .addComponent(LoadRecentMovementsButton, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(getAllMovementsButton, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(LoadRecentMovementsButton, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(layout.createSequentialGroup()
                            .addGap(36, 36, 36)
                            .addComponent(SearchEmployeeIdLabel)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            .addGap(57, 57, 57)
                            .addComponent(getAllMovementsButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(PositionLabel)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(MovementTypeButton)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(MovementTypeComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(NewPositionLabel)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void SearchEmployeeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchEmployeeButtonActionPerformed
        ...
        emp = Empleado.getInformacionEmpleado(idEmpleado);
        if (emp == null){
            JOptionPane.showMessageDialog(this,
            ...
            JOptionPane.showMessageDialog(this,
                "Empleado encontrado: " + emp.getNombre()+ " " + emp.getApellido(),
                "Exito",
                JOptionPane.INFORMATION_MESSAGE);
            EmployeeNameTxt.setText(emp.getNombre()+ " " + emp.getApellido());
            idEncontrado = idEmpleado;
            PositionTxt.setText(emp.getCargo());
    ...
    private void LoadRecentMovementsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoadRecentMovementsButtonActionPerformed
        ...
        ArrayList<MovimientoPersonal> movimientos = MovimientoPersonal.consultarMovimientosEmpleado(idEncontrado);
        ...
        for (MovimientoPersonal movimiento : movimientos) {
    ...
    private void MakeTransitionButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MakeTransitionButtonActionPerformed
        try {
            ...
            double salarioAnterior = Empleado.getInformacionEmpleado(idEncontrado).getSalario();
            ...
            boolean exito = MovimientoPersonal.registrarMovimiento(idEmpleado, tipoMovimiento, fecha, "Movimiento de empleado a " + nuevoPuesto + " en " + departamento);
            ...
            Logger.getLogger(ControlMovimientoPersonalForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void EmployeeIdTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EmployeeIdTxtActionPerformed
        // Suponiendo que tienes un JTextField llamado EmployeeIdTxt
        EmployeeIdTxt.addActionListener((ActionEvent evt1) -> {
            // Obtener el texto del campo EmployeeIdTxt
            String employeeIdText = EmployeeIdTxt.getText();
            
            // Verificar si el campo está vacío o solo contiene espacios
            if (employeeIdText == null || employeeIdText.trim().isEmpty()) {
                // Limpiar otros campos y desactivar botones
                EmployeeNameTxt.setText("");
                MovementTypeComboBox.setEnabled(false);
                DepartmentComboBox.setEnabled(false);
                NewPositionTxt.setEnabled(false);
    ...
    private void getAllMovementsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getAllMovementsButtonActionPerformed
        try {
            ...
            ArrayList<MovimientoPersonal> movimientos;
            movimientos = MovimientoPersonal.generarReporteMovimientos("01/01/1999", "31/12/2040");
            if(movimientos == null || movimientos.isEmpty()){
                JOptionPane.showMessageDialog(this,
                        "Error al consultar las acciones.",
                        "Error",
            ...
            for (MovimientoPersonal movimiento : movimientos) {
                ...
                row[0] = movimiento.getIdMovimiento();
                row[1] = movimiento.getIdEmpleado();
                row[2] = movimiento.getTipoMovimiento();
                row[3] = movimiento.getFechaMovimiento();
                row[4] = movimiento.getDetalle();
                model.addRow(row);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ControlMovimientoPersonalForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ControlMovimientoPersonalForm().setVisible(true);
        });
    }
