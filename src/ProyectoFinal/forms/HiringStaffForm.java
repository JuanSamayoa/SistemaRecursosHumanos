...
public class HiringStaffForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        EmployeeSalaryTxt.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(
        ...
        ContractualTypeComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(
                new String[] { "Selecciona una opción", "Contrato por tiempo indefinido",
                        "Contrato por tiempo definido", "Contrato por obra", "Contrato por servicios" }));
        ...
        StartDateTxt.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                .addGroup(layout
                                                        ...
                                                        .addGroup(layout.createSequentialGroup()
                                                                ...
                                                                .addGroup(layout.createParallelGroup(
                                                                        ...
                                                                        .addComponent(EmployeeSalaryTxt,
                                                                                javax.swing.GroupLayout.Alignment.LEADING)
                                                                        .addComponent(EmployeePositionTxt,
                                                                                javax.swing.GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addGroup(layout
                                                                ...
                                                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING,
                                                                        layout.createSequentialGroup()
                                                                                ...
                                                                                .addPreferredGap(
                                                                                        javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                                .addComponent(ContractualTypeComboBox,
                                                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                        190,
                                                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                                                .addGroup(layout.createSequentialGroup()
                                                        ...
                                                        .addGroup(layout.createSequentialGroup()
                                                                ...
                                                                .addPreferredGap(
                                                                        javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                .addComponent(ContractualWorkTimeTxt,
                                                ...
                                                .addGroup(layout
                                                        ...
                                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout
                                                                ...
                                                                .addPreferredGap(
                                                                        javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                                .addComponent(SelectContractButton,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE, 181,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void ContractConsultButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ContractConsultButtonActionPerformed
        ...
        ContractsTable.setModel(new javax.swing.table.DefaultTableModel(
                new Object[][] {},
                new String[] {
                        "ID Contrato", "ID Empleado", "Fecha de inicio", "Tipo de contrato", "Duración de contrato",
                        "Salario"
                }));
        ...
        JOptionPane.showMessageDialog(null, "Contratos vigentes consultados exitosamente.", "Éxito",
    ...
    private void EndContractButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_EndContractButtonActionPerformed
        ...
        if (ContractsTable.getSelectedRow() == -1) {
            ...
            JOptionPane.showMessageDialog(null, "Por favor, seleccione un contrato.", "Error",
                    JOptionPane.ERROR_MESSAGE);
            return;
        }

        // Preguntar si está seguro de finalizar el contrato
        int dialogResult = JOptionPane.showConfirmDialog(null, "¿Está seguro de finalizar el contrato?", "Confirmación",
        ...
        if (exito) {
            JOptionPane.showMessageDialog(null, "Contrato finalizado correctamente", "Información",
                    JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(null, "No se ha podido finalizar el contrato", "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void ContractualTypeComboBoxActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ContractualTypeComboBoxActionPerformed
        // Si el tipo de contrato es por tiempo indefinido, no se debe ingresar un
        // tiempo de contrato
    ...
    private void AddContractButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_AddContractButtonActionPerformed
        ...
        int dialogResult = JOptionPane.showConfirmDialog(null, "¿Desea crear el contrato para el empleado?",
        ...
        if (empleado == null) {
            ...
            int duracion = 0;
            if (ContractualTypeComboBox.getSelectedIndex() == 2 || ContractualTypeComboBox.getSelectedIndex() == 3
                    || ContractualTypeComboBox.getSelectedIndex() == 4) {
    ...
    private void SelectContractButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_SelectContractButtonActionPerformed
        ...
        if (ContractsTable.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(null, "Por favor, seleccione un contrato.",
                    "Error al obtener informacion del contrato", JOptionPane.ERROR_MESSAGE);
            return;
        }
        int idContrato = Integer.parseInt(ContractsTable.getValueAt(ContractsTable.getSelectedRow(), 0).toString());
    ...
    private void ModifyContractButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ModifyContractButtonActionPerformed
        if (ContractsTable.getSelectedRow() == -1 || "".equals(ContractIdTxt.getText())
                || ContractIdTxt.getText() == null) {
            JOptionPane.showMessageDialog(null, "Por favor, seleccione un contrato.",
                    "Error al obtener información del contrato", JOptionPane.ERROR_MESSAGE);
            return;
        }

        // Solicitar confirmacion de si desea eliminar al empleado
        int dialogResult = JOptionPane.showConfirmDialog(null, "¿Desea modificar el contrato selecionado?",
        ...
        if (exito) {
            JOptionPane.showMessageDialog(null, "Contrato modificado correctamente", "Información",
                    JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(null, "No se ha podido modificar el contrato",
                    "Error al modificar el contrato", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HiringStaffForm.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
