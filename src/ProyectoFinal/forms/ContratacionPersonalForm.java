...
import ProyectoFinal.Contratacion;
 ...
 * @author User
 */
public class ContratacionPersonalForm extends javax.swing.JFrame {

    /**
     * Creates new form ContratacionPersonalForm
     */
    public ContratacionPersonalForm() {
        initComponents();
    }
    ...
    private void ContractConsultButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ContractConsultButtonActionPerformed
        ...
        Contratacion.consultarContratosVigentes();
        ...
        for (Contratacion contrato : Contratacion.contratosActivos) {
    ...
    private void EndContractButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EndContractButtonActionPerformed
        ...
        boolean exito = Contratacion.finalizarContrato(idContrato);
        if (exito){
    ...
    private void SearchEmployeeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchEmployeeButtonActionPerformed
        ...
        EmployeeSalaryTxt.setText("Q" + empleado.getSalario());
    ...
    private void AddContractButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddContractButtonActionPerformed
        ...
        empleado = Empleado.getInformacionEmpleado(Integer.parseInt(EmployeeIdTxt.getText()));
        if (empleado == null){
            JOptionPane.showMessageDialog(this,
            ...
            if (!SistemaRecursosHumanos.validarFecha(fechaInicio)) {
                JOptionPane.showMessageDialog(this,
            ...
            boolean contrato = Contratacion.agregarContrato(idEmpleado, fechaInicio, tipoContrato, duracion, salario);
            if(!contrato){
                JOptionPane.showMessageDialog(this,
    ...
    private void ModifyContractButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModifyContractButtonActionPerformed
        ...
        boolean exito;
        try {
            exito = Contratacion.modificarContrato(idContrato, idEmpleado, fechaInicio, tipoContrato, duracion, salario);
            if (exito){
            ...
            Logger.getLogger(ContratacionPersonalForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContratacionPersonalForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ContratacionPersonalForm().setVisible(true);
        });
    }
