...
public class AbsenceAndVacationsForm extends javax.swing.JFrame {
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(AbsenceVacationsReportLabel)
                                .addGap(3, 3, 3)
                                .addComponent(ConsultRecentActionsButton, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void ConsultRecentActionsButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ConsultRecentActionsButtonActionPerformed
        ...
        try {
            ...
            ArrayList<PersonalActionsReport> reportData = PersonalActionsReport.generatePersonalActionsReport(startDate,
                    endDate);
            ...
            if (reportData.isEmpty()) {
                JOptionPane.showMessageDialog(this,
                        "No se encontraron acciones personales en el rango de fechas: " + fechaInicio + " - "
                                + fechaFin,
                        "Sin resultados",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AbsenceAndVacationsForm.class.getName())
