...
import ProyectoFinal.PersonalActions;
...
public class PersonalActionControlForm extends javax.swing.JFrame {
     ...
     */
    public PersonalActionControlForm() {
        initComponents();
    }
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGroup(layout
                                                        ...
                                                        .addGroup(layout.createSequentialGroup()
                                                                ...
                                                                .addGap(75, 75, 75)
                                                                .addComponent(LoadRecentActionsButton,
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(EmployeeIdTxt, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(SearchEmployeeButton)
                                        .addComponent(LoadRecentActionsButton, javax.swing.GroupLayout.PREFERRED_SIZE,
    ...
    private void UnpaidLeaveButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_UnpaidLeaveButtonActionPerformed
        try {
            ...
            boolean exito = PersonalActions.add(idEncontrado, "Permiso", fechaInicio,
                    "Permiso sin goce de salario con fecha " + fechaInicio + " solicitada la fecha " + fechaActual);
            ...
            Logger.getLogger(PersonalActionControlForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void SpouseDeathLeaveButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_SpouseDeathLeaveButtonActionPerformed
        try {
            ...
            int dialogResult = JOptionPane.showConfirmDialog(this,
                    "¿Desea registrar un permiso por fallecimiento de cónyuge?",
                    "Confirmación", JOptionPane.YES_NO_OPTION);
            if (dialogResult == JOptionPane.NO_OPTION) {
                return;
            }
            ...
            boolean exito = PersonalActions.add(idEncontrado, "Permiso", fechaActual,
                    "Permiso por fallecimiento de cónyuge");
    ...
    private void ParentalLeaveButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ParentalLeaveButtonActionPerformed
        try {
            // Mensaje de confirmacion si desea solicitar un permiso sin goce de salario
            int dialogResult = JOptionPane.showConfirmDialog(this,
                    "¿Desea registrar un permiso por nacimiento de hijos?",
                    "Confirmación", JOptionPane.YES_NO_OPTION);
            if (dialogResult == JOptionPane.NO_OPTION) {
                return;
            }
            ...
            boolean exito = PersonalActions.add(idEncontrado, "Permiso", fechaInicio,
                    "Permiso por nacimiento de hijos solicitada fecha " + fechaActual);
    ...
    private void SickLeaveButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_SickLeaveButtonActionPerformed
        try {
            ...
            boolean exito = PersonalActions.add(idEncontrado, "Permiso", fechaActual,
                    "Permiso por enfermedad para el dia " + fechaInicio);
    ...
    private void ParentalDeathLeaveButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ParentalDeathLeaveButtonActionPerformed
        try {
            int dialogResult = JOptionPane.showConfirmDialog(this,
                    "¿Desea registrar un permiso por fallecimiento de padres?",
                    "Confirmación", JOptionPane.YES_NO_OPTION);
            if (dialogResult == JOptionPane.NO_OPTION) {
                return;
            }
            ...
            boolean exito = PersonalActions.add(idEncontrado, "Permiso", fechaActual,
                    "Permiso por fallecimiento de padres");
    ...
    private void PrivateExamenLicenseButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_PrivateExamenLicenseButtonActionPerformed
        try {
            ...
            boolean exito = PersonalActions.add(idEncontrado, "Licencia", fechaInicio,
                    "Licencia por examen privado solicitado " + fechaActual);
    ...
    private void VacationsButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_VacationsButtonActionPerformed
        try {
            ...
            int diasVacaciones = Employee.calculateVacations(idEncontrado);
            if (diasVacaciones <= 0) {
                JOptionPane.showMessageDialog(this,
            ...
            boolean exito = PersonalActions.add(idEncontrado, "Vacaciones", fechaActual,
                    "Permiso por vacaciones para el periodo " + fechaInicio + " a " + fechaFin);
    ...
    private void AbsenceButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_AbsenceButtonActionPerformed
        try {
            ...
            boolean exito = PersonalActions.add(idEncontrado, "Otros", fechaInicio,
                    "Ausencia solicitada fecha " + fechaActual);
    ...
    private void LoadRecentActionsButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_LoadRecentActionsButtonActionPerformed
        ...
        for (PersonalActions accion : acciones) {
            model.addRow(new Object[] { accion.getId(), accion.getActionType(), accion.getActionDate(),
                    accion.getDetail() });
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PersonalActionControlForm.class.getName())
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PersonalActionControlForm().setVisible(true);
            }
        });
    }
