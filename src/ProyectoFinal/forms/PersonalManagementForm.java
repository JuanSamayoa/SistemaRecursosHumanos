...
public class PersonalManagementForm extends javax.swing.JFrame {
    ...
    private void UpdateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateButtonActionPerformed
        ...
        if(fila >= 0 && !EmployeeIDTxt.getText().equals("") && Integer.parseInt(EmployeeIDTxt.getText()) > 0){
            ...
            if("".equals(nombre) || nombre == null){
                JOptionPane.showMessageDialog(null, "No se ha ingresado el nombre del empleado.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }

            if("".equals(apellido) || apellido == null){
                JOptionPane.showMessageDialog(null, "No se ha ingresado el apellido del empleado.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }

            if("".equals(fechaContratacion) || fechaContratacion == null){
                JOptionPane.showMessageDialog(null, "No se ha ingresado la fecha de contratación.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }

            // FIXED: Use Utils.validateDate instead of old validation
            if(!Utils.validateDate(fechaContratacion)){
                JOptionPane.showMessageDialog(null, "La fecha de contratación no es válida. Use formato dd/MM/yyyy", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }

            if("".equals(cargo) || cargo == null){
                JOptionPane.showMessageDialog(null, "No se ha ingresado el cargo del empleado.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }

            if(DepartmentComboBox.getSelectedIndex() <= 0){
                JOptionPane.showMessageDialog(null, "No se ha seleccionado el departamento.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            try {
                ...
                if(!Utils.validateSalary(salario)){
                    JOptionPane.showMessageDialog(null, "El salario debe ser mayor que 0.", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(null, "El salario ingresado no es válido.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }

            // Update employee using Employee.update() method
            boolean actualiza = Employee.update(idEmpleado, nombre, apellido, fechaContratacion, cargo, salario, departamento);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PersonalManagementForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
